...
builder.BASE = ROOT / "art_candidates" / "character_runtime_v19_cast_prayer_stable_clean"
builder.BASE_IMPORT_NAME = "DoubleSS_character_v19_import_3.8.json"
builder.SOURCE = ROOT / "art_candidates" / "video_source" / "cast_prayer" / "preview_v7_stable_clean" / "alpha_frames"
builder.OUTPUT = ROOT / "art_candidates" / "character_runtime_v20_cast_prayer_1200ms"
builder.OUTPUT_IMPORT_NAME = "DoubleSS_character_v20_import_3.8.json"
