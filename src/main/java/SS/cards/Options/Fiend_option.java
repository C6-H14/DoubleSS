...
public class Fiend_option extends CustomCard {
    public static final String ID = ModHelper.makePath("Fiend_option");
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "img/cards/Fiend_option.png";
    ...
    public void onChoseThisOption() {
        ...
        this.addToBot(new UpdateFiendStanceDescriptions());
    }

    public AbstractCard makeCopy() {
        return new Fiend_option();
    }
}
