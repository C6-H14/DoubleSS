...
public class UncommonCardOption extends CustomCard {
    public static final String ID = ModHelper.makePath("UncommonCardOption");
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new DiscoveryByRarityAction(CardRarity.UNCOMMON,
