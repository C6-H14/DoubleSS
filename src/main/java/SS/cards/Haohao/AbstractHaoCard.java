...
public abstract class AbstractHaoCard extends AbstractDoubleCard {
    ...
    public AbstractHaoCard(String id, String name, String img, int cost, String rawDescription,
        ...
        super(id, name, img, cost, rawDescription, type, PackageEnum.Hao, rarity, target);
    ...
    public AbstractHaoCard(String id, String name, String img, int cost, String rawDescription,
        ...
        super(id, name, img, cost, rawDescription, type, PackageEnum.Hao, rarity, target, card_string, exstrings, false,
                true);
        this.tags.add(AbstractCardEnum.Manager);
    }
    ...
    public AbstractHaoCard(String id, String name, String img, int cost, String rawDescription,
            ...
            boolean manager) {
        super(id, name, img, cost, rawDescription, type, PackageEnum.Hao, rarity, target, card_string, exstrings, fiend,
                manager);
        if (fiend)
