...
public class PlaySpecificCardInHand extends AbstractGameAction {
    private boolean exhaustCards;
    private AbstractCard card;

    public PlaySpecificCardInHand(AbstractCreature target, AbstractCard c, boolean exhausts) {
    ...
    public void update() {
        if (this.duration == Settings.ACTION_DUR_FAST) {
            ...
            if (!AbstractDungeon.player.hand.group.isEmpty() && AbstractDungeon.player.hand.group.contains(card)
                    && canUseCard(card)) {
