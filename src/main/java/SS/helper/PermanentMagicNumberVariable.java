...
public class PermanentMagicNumberVariable extends DynamicVariable {
    @Override
    public String key() {
        return "Double:PermanentMagicNumber";
    ...
    public int baseValue(AbstractCard card) {
        if (card instanceof AbstractLostCard) {
            AbstractLostCard c = (AbstractLostCard) card;
            return c.basePermanentMagicNumber;
        }
        return 0;
    ...
    public boolean upgraded(AbstractCard card) {
        if (card instanceof AbstractLostCard) {
            AbstractLostCard c = (AbstractLostCard) card;
            return c.upgradePermanentMagicNumber;
        }
        return false;
