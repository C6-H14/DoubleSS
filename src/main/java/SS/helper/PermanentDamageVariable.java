...
public class PermanentDamageVariable extends DynamicVariable {
    @Override
    public String key() {
        return "Double:PermanentDamage";
    ...
    public boolean isModified(AbstractCard card) {
        ...
        if (card instanceof AbstractLostCard) {
            return ((AbstractLostCard) card).upgradePermanentDamage;
        }
        return false;
    ...
    public boolean upgraded(AbstractCard card) {
        if (card instanceof AbstractLostCard) {
            AbstractLostCard c = (AbstractLostCard) card;
            return c.upgradePermanentDamage;
        }
        return false;
