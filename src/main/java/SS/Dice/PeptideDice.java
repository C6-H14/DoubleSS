...
public class PeptideDice extends AbstractDice {
    ...
    public PeptideDice(int damage, AbstractMonster m) {
        this.ID = ORB_ID;
        this.img = ImageMaster.loadImage("img/dice/PeptideDice.png");
    ...
    public AbstractDice makeCopy() {
        return new PeptideDice(this.baseEvokeAmount, (AbstractMonster) this.target);
    }
}