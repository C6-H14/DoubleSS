...
public class EternalDefendDice extends AbstractDice {
    ...
    public EternalDefendDice(int damage, AbstractPlayer p) {
        this.ID = ORB_ID;
        this.img = ImageMaster.loadImage("img/dice/EternalDefendDice.png");
    ...
    public AbstractDice makeCopy() {
        return new EternalDefendDice(this.baseEvokeAmount, (AbstractPlayer) this.target);
    }
}